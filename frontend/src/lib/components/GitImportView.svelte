...
<div class="git-import-container">
  ...
  <div class="form-group">
    ...
    <input
      ...
      disabled={loading}
    />
    <p class="field-hint">The path to the collection within the repository.</p>
  </div>
  ...
  <div class="info-box">
    ...
    <span>Yapla will automatically detect the collection name from the file content.</span>
  </div>
