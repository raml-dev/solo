/**
 * This file is excerpted from @fsegurai/codemirror-theme-vscode-light@6.2.6
...
export const vsCodeLightHighlightStyle = /*@__PURE__*/ HighlightStyle.define([
  ...
  { tag: [/*@__PURE__*/ tags.special(tags.string), tags.regexp], color: base09 },
