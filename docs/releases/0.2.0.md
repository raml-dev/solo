...
- Added [golang.org/x/image v0.40.0](https://pkg.go.dev/golang.org/x/image) ([#150](https://github.com/raml-dev/solo/pull/150))
  > [!NOTE]
  >
  > Right now we're using [a fork](https://github.com/matstech/image) of the library to fix a bug we found. We opened an issue upstream.
